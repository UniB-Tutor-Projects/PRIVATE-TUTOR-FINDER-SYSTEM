 ...
 <div class="center_hm pt-5 pb-5">
  <div class="container-xl">
   <div class="center_h1 row">
    <div class="col-md-7">
	 <div class="center_h1l">
	  <h2 class="text-white">Hire The Right <br> Tutor Today!</h2>
	  <p class="mt-3 text-light">"An investment in Knowledge pays the best interest."</p>
	 </div>
	</div>
		</div>
   </div>
...
<section id="spec" class="p_3 bg_brown">
 <div class="container-xl">
   <div class="row spec_1">
    <div class="col-md-4">
	 <div class="spec_1i">
	  <h5 class="text-white fw-normal mb-0"><i class="fa fa-user me-2 font_60 lh-1 align-middle"></i> 5 million students</h5>
	 </div>
	</div>
	<div class="col-md-4">
	 <div class="spec_1i">
	  <h5 class="text-white fw-normal mb-0"><i class="fa fa-book me-2 font_60 lh-1 align-middle"></i> 134k online courses</h5>
	 </div>
	</div>
	<div class="col-md-4">
	 <div class="spec_1i">
 ...
 <div class="container-xl">
   <div class="row course_1">
     <div class="col-md-9">
	  <div class="course_1l">
<<<<<<< Updated upstream
	   <h3 class="mb-0">Our Popular Teachers</h3>
	  </div>
	 </div>
   </div>
...
<<<<<<< Updated upstream
		      <h6 class="mb-0"><a class="bg_brown d-inline-block px-3 pt-2 pb-2 text-white font_14 rounded-3" href="#"> Technology</a></h6>
		   </div>
		   </div>
		   <div class="course_3im2 p-3 shadow_box">
		    <h6><img src="img/8.jpg" class="rounded-circle me-2" alt="abc"> Uni B</h6>
			<h5 class="mt-3 mb-3"><a href="#">Back-End Engineering</a></h5>
=======
...
>>>>>>> Stashed changes
			...
			<hr>
<<<<<<< Updated upstream
			<h6 class="font_14 fw-bold mb-0"> <span class="text-decoration-line-through text-muted mx-2">FCFA10,000/hr</span> <span class="col_brown">FCFA5,000/hr</span></h6>
=======
...
<<<<<<< Updated upstream
		   ...
		   <div class="course_3im2 p-3 shadow_box">
		    <h6><img src="img/9.jpg" class="rounded-circle me-2" alt="abc"> Nyong Godwill</h6>
			<h5 class="mt-3 mb-3"><a href="#">Product Design</a></h5>
=======
...
>>>>>>> Stashed changes
			...
			<hr>
<<<<<<< Updated upstream
			<h6 class="font_14 fw-bold mb-0"><span class="text-decoration-line-through text-muted mx-2">FCFA8,000/hr</span> <span class="col_brown">FCFA4,000/hr</span></h6>
=======
...
<<<<<<< Updated upstream
		   ...
		   <div class="course_3im2 p-3 shadow_box">
		    <h6><img src="img/10.jpg" class="rounded-circle me-2" alt="abc"> Nfon Andrew</h6>
			<h5 class="mt-3 mb-3"><a href="#">System Administration</a></h5>
=======
...
>>>>>>> Stashed changes
			...
			<hr>
<<<<<<< Updated upstream
			<h6 class="font_14 fw-bold mb-0"> <span class="text-decoration-line-through text-muted mx-2">FCFA25,000/hr</span> <span class="col_brown">FCFA15,000/hr</span></h6>
=======
...
<<<<<<< Updated upstream
		   ...
		   <div class="course_3im2 p-3 shadow_box">
		    <h6><img src="img/8.jpg" class="rounded-circle me-2" alt="abc"> Soh Juvitus</h6>
			<h5 class="mt-3 mb-3"><a href="#">Professional Development</a></h5>
=======
		      <h6 class="mb-0"><a class="bg_brown d-inline-block px-3 pt-2 pb-2 text-white font_14 rounded-3" href="#"> Business</a></h6>
		   </div>
		   </div>
		  ...
		  <div class="course_3im clearfix">
		   <div class="course_3im1 position-relative clearfix">
		     <div class="course_3im1i clearfix">
			  ...
			  <div class="course_3im1i1 position-absolute w-100 top-0 clearfix p-3">
<<<<<<< Updated upstream
		      <h6 class="mb-0"><a class="bg_brown d-inline-block px-3 pt-2 pb-2 text-white font_14 rounded-3" href="#"> Science</a></h6>
		   </div>
		   </div>
		   <div class="course_3im2 p-3 shadow_box">
		    <h6><img src="img/9.jpg" class="rounded-circle me-2" alt="abc"> Kombe Peter</h6>
			<h5 class="mt-3 mb-3"><a href="#">Inorganic Chemistry</a></h5>
=======
		      <h6 class="mb-0"><a class="bg_brown d-inline-block px-3 pt-2 pb-2 text-white font_14 rounded-3" href="#"> Politics</a></h6>
		   </div>
		   </div>
...
>>>>>>> Stashed changes
			...
			<hr>
<<<<<<< Updated upstream
			<h6 class="font_14 fw-bold mb-0"><span class="text-decoration-line-through text-muted mx-2">FCFA15,000/hr</span> <span class="col_brown">FCFA10,000/hr</span></h6>
=======
			<h6 class="font_14 fw-bold mb-0"><i class="fa fa-user col_brown me-1"></i> 14 students <i class="fa fa-book col_brown me-1 ms-2"></i> 06 lessons <span class="text-decoration-line-through text-muted mx-2">$160</span> <span class="col_brown">$70</span></h6>
>>>>>>> Stashed changes
		   </div>
		  ...
		  <div class="course_3im clearfix">
		   <div class="course_3im1 position-relative clearfix">
		     <div class="course_3im1i clearfix">
			  ...
			  <div class="course_3im1i1 position-absolute w-100 top-0 clearfix p-3">
<<<<<<< Updated upstream
		      <h6 class="mb-0"><a class="bg_brown d-inline-block px-3 pt-2 pb-2 text-white font_14 rounded-3" href="#"> Arts</a></h6>
		   </div>
		   </div>
		   <div class="course_3im2 p-3 shadow_box">
		    <h6><img src="img/10.jpg" class="rounded-circle me-2" alt="abc"> Nala Fred</h6>
			<h5 class="mt-3 mb-3"><a href="#">Poetry</a></h5>
=======
		      <h6 class="mb-0"><a class="bg_brown d-inline-block px-3 pt-2 pb-2 text-white font_14 rounded-3" href="#"> Psychology</a></h6>
		   </div>
		   </div>
...
>>>>>>> Stashed changes
			...
			<hr>
<<<<<<< Updated upstream
			<h6 class="font_14 fw-bold mb-0"><span class="text-decoration-line-through text-muted mx-2">FCFA7,000/hr</span> <span class="col_brown">FCFA4,000/hr</span></h6>
=======
			<h6 class="font_14 fw-bold mb-0"><i class="fa fa-user col_brown me-1"></i> 12 students <i class="fa fa-book col_brown me-1 ms-2"></i> 04 lessons <span class="text-decoration-line-through text-muted mx-2">$140</span> <span class="col_brown">$50</span></h6>
>>>>>>> Stashed changes
		   </div>
	...
	<div class="learn_2 row">
	 <div class="col-md-2 col-sm-6">
	  <div class="learn_2i bg_dark px-3 pt-4 pb-4 rounded-3 text-center">
	   <span class="lh-1 font_60 text-white"><i class="fa fa-ambulance"></i></span>
	   <h6 class="mb-0 mt-3 text-white">Medicine</h6>
	  </div>
	 </div>
	 <div class="col-md-2 col-sm-6">
	  <div class="learn_2i bg-info px-3 pt-4 pb-4 rounded-3 text-center">
	   <span class="lh-1 font_60 text-white"><i class="fa fa-user-md"></i></span>
	   <h6 class="mb-0 mt-3 text-white">Pharmacy</h6>
	  </div>
	 </div>
	 <div class="col-md-2 col-sm-6">
	  <div class="learn_2i bg-warning px-3 pt-4 pb-4 rounded-3 text-center">
	   <span class="lh-1 font_60 text-white"><i class="fa fa-hard-of-hearing"></i></span>
	   <h6 class="mb-0 mt-3 text-white">Psychology</h6>
	  </div>
	 </div>
	 <div class="col-md-2 col-sm-6">
   				...
   				<div class="container-xl">
    				<div class="footer_1 row">
	 					<div class="col-md-4">
	  						<div class="footer_1i">
	    						<div class="top_1l">
									<h4 class="mb-0"><a class="text-white" href="index.html"><span class="span_1 text-uppercase"><i class="fa fa-graduation-cap text-white fs-2 align-middle col_brown"></i> Academy</span> <br> <span class="font_12 span_2 text-light fw-normal">University & College</span></a></h4>
	  						...
	  						<div class="footer_1i">
	    						<h4 class="col_brown mb-4">Category</h4>
		   						<div class="row footer_1ism">
	 								...
	 								<h6 class="fw-normal mt-2 col-md-12 col-6"><a class="text-light" href="#"> Natural</a></h6>
	 								<h6 class="fw-normal mt-2 col-md-12 col-6"><a class="text-light" href="#"> Architecture</a></h6>
	 								<h6 class="fw-normal mt-2 col-md-12 col-6"><a class="text-light" href="#"> Electrical</a></h6>
	 								<h6 class="fw-normal mt-2 col-md-12 col-6"><a class="text-light" href="#"> Biological</a></h6>
	 								<h6 class="fw-normal mt-2 col-md-12 col-6 mb-0"><a class="text-light" href="#"> Psychology</a></h6>
	    						</div>
	  						</div>
	 					</div>
	 					<div class="col-md-2">
	 					...
	 					<div class="col-md-4">
	  						<div class="footer_1i">
	    						<h4 class="col_brown mb-4">Contact Us</h4>
		 						<p class="text-light">Helped thousands of clients to find the right property for their needs.</p>
		 						<h6 class="mt-4 text-light"><i class="fa fa-map-marker col_brown me-2 fs-4 align-middle"></i> Z793 STower Suat, DB 8513 UK</h6>
		 						<h6 class="mt-4 text-light"><i class="fa fa-microphone col_brown me-2 fs-4 align-middle"></i> +(123) 456-7890</h6>
		 						<h6 class="mt-4 text-light mb-0"><i class="fa fa-headphones col_brown me-2 fs-4 align-middle"></i> info@gmail.com</h6>
	  						</div>
	 					</div>
					</div>
  				</div>
